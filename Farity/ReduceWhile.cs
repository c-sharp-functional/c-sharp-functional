...
namespace Farity
{
    public static partial class F
    {
        ...
        public static T ReduceWhile<T, TSource>(Func<T, TSource, bool> predicate, Func<T, TSource, T> reducer, T seed,
        ...
        /// <param name="items">The list of items over which to reduce.</param>
        /// <returns>The reduced value of the list using the provided seed and reducer function.</returns>
        public static T ReduceWhile<T, TSource>(FuncAny<bool> predicate, Func<T, TSource, T> reducer, T seed,
            IEnumerable<TSource> items)
            => ReduceWhile((reduced, current) => predicate(reduced, current), reducer, seed, items);
    }
}